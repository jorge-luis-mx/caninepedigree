<x-app-layout>
   ...
   <p class="counter">Cantidad: <span id="counter">0</span></p>
   <div class="buttons">
      <button class="add-btn" id="add-btn">Agregar</button>
      <button class="remove-btn" id="remove-btn">Quitar</button>
   </div>
   ...
   <div class="columns is-multiline mt-4">
      ...
      <div class="column is-full card">
         <form action="{{ route('dogs.store') }}" method="post" id="dog-form">
            ...
            <div class="card groupsForms m-4" style="box-shadow: none; margin-bottom: 30px;">
