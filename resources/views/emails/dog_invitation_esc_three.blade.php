...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; padding: 20px;">
    ...
    <p>
        La perra <strong>{{ $datos['dog']->name}}</strong> está interesada en cruzarse con tu perro.
    </p>
    ...
    <p style="text-align: center;">
        <a href="{{ $datos['url'] }}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Registrar a mi perro</a>
    </p>
