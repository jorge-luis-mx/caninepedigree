<x-app-layout>
   ...
   <h1 class="is-size-4">Registered Dogs in Our System</h1>

   <div class="columns is-multiline">
      <div class="column">
         <div class="menu-add">
            <a href="{{ route('dogs.create')}}">
               <div class="card has-background-grey-lighter" style="width: 135px;box-shadow:none; padding: 8px 0px 8px 0px;" >
                  <div class="card-content" style="padding: 0; margin:0;">
                     <div class="is-flex is-justify-content-center">
                        ...
                        <span class="is-block">Add a Dog</span>
                     </div>
                  </div>
               </div>
            </a>
